  ...
  if (callback && this.manager.rooms[this.flags.endpoint]) {
    for (var i=0, l=this.manager.rooms[this.flags.endpoint].length; i<l; i++) {
      ...
      if (!~this.flags.exceptions.indexOf(id)) {
        //if is default namespaces
        if(this.manager.namespaces[this.flags.endpoint] == null || this.manager.namespaces[this.flags.endpoint]== "undefined") {
          this.manager.namespaces[''].sockets[id].acks[packet.id] = callback;
        } else {
